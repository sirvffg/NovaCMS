...
if (isset($_GET['id'])) {
    ...
    <!-- Open Graph / Facebook -->
    <?php 
    $postCoverUrl = !empty($post['cover_image']) ? $post['cover_image'] : '';
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 post-recommendation-card">
                            <?php 
                            $recCoverUrl = !empty($recPost['cover_image']) ? $recPost['cover_image'] : '';
                        ...
                        <div class="card blog-list-card" onclick="window.location.href='/blog.php?id=<?= $post['id'] ?>'">
                            <div class="row g-0">
                                ...
                                <div class="col-md-4 d-none d-md-block">
                                    <div class="d-flex h-100 align-items-center justify-content-center p-2">
                                        <?php 
                                        $listCoverUrl = !empty($post['cover_image']) ? $post['cover_image'] : '';
